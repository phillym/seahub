...
from seahub.api2.endpoints.revision_tag import RevisionTags, RevisionTag
...
urlpatterns = patterns(
    ...
    url(r'^api/v2.1/repos/(?P<repo_id>[-0-9a-f]{36})/revision/tags/$', RevisionTags.as_view(), name='api-v2.1-revision-tags'),
    url(r'^api/v2.1/repos/(?P<repo_id>[-0-9a-f]{36})/revision/(?P<commit_id>[0-9a-f]{40})/tags/$', RevisionTags.as_view(), name='api-v2.1-post-revision-tags'),
    url(r'^api/v2.1/repos/(?P<repo_id>[-0-9a-f]{36})/revision/(?P<commit_id>[0-9a-f]{40})/tags/(?P<tag_name>.*?)/$', RevisionTag.as_view(), name='api-v2.1-revision-tag'),
